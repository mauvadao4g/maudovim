...
" Plugins do Git
Plug 'Xuyuanp/nerdtree-git-plugin'    " Plugin que adiciona ícones de status do Git no NERDTree
Plug 'tpope/vim-fugitive'             " Plugin para integração com Git
Plug 'tpope/vim-rhubarb'              " Plugin que complementa o vim-fugitive com suporte ao GitHub
Plug 'junegunn/gv.vim'                " Visualizador de commit do Git
