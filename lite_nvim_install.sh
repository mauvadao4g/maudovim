...
# VIDEO BASE RETIRADO DO YOUTUBE, MAS ESSE SCRIPT ESTA TOTALMENTE EDITADO POR MAUVADAO
title="Como instalar Neovim en Windows e instalar vim plug mas plugins de personalización
"
video="https://www.youtube.com/watch?v=N0Zq1xhJEes"
